...
$plugin_url = WB_URL.'/modules/tiny_mce_jq/tiny_mce/plugins/droplets';
$plugin_path = WB_PATH.'/modules/tiny_mce_jq/tiny_mce/plugins/droplets';
...
// Setup the template
$template = new Template(WB_PATH.'/modules/tiny_mce_jq/tiny_mce/plugins/droplets');
$template->set_file('page', 'droplets.htt');
...
$template->set_var(array(
            'dropletsDlgTitle' => $dropletsDlgTitle,
            'dropletslblInsert' => $dropletslblInsert,
            'dropletslblCancel' => $dropletslblCancel,
            'dropletslblPageSelection' => $dropletslblPageSelection,
